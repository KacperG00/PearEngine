...
namespace pear { namespace graphics {
	...
	SS_Animation::SS_Animation(const char* texture_name, int nosh, int nosv, int first_sprite, int last_sprite)
		: m_NumOfCurrFrame(0)
	{
		m_NormPos = loadDataRegDim( texture_name, nosh, nosv, first_sprite, last_sprite );
	...
	std::vector<glm::vec4> SS_Animation::loadDataRegDim(const char* texture_name, int nosh, int nosv, int first_frame, int last_frame)
	{
